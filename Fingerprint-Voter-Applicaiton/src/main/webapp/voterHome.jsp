...
<body>
	...
	ResultSet resultset = statement.executeQuery(
			"SELECT voter_card_number, firstname, middlename, lastname, dob, address, image FROM voter WHERE voter_card_number = '" + voterId + "'");
	...
	<div class="container">
		...
		<div class="form-group">
			<label>Voter Photo: </label> <img id="photo-preview"
				class="image-preview" src="voterImages/<%=resultset.getString(7)%>"
